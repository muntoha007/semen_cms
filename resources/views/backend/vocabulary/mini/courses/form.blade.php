...
@endphp
@section('title', 'Mini Level KosaKata ' . $title)
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ $title }} Mini Level Kosakata</h4>
                        <br>
                        <form class="forms-sample"
                            action="{{ @$data ? route('vocabulary-mini-courses.update', $data->id) : route('vocabulary-mini-courses.store') }}"
                            ...
                            <a href="{{ route('vocabulary-mini-courses.index') }}"
