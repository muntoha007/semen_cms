...
@endphp
@section('title', 'Pertanyaan Mini Kosakata ' . $title)
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ $title }} Pertanyaan Mini Kosakata</h4>
                        <br>
                        <form class="forms-sample"
                            action="{{ @$data ? route('vocabulary-mini-course-questions.update', $data->id) : route('vocabulary-mini-course-questions.store') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="vocabulary_mini_course_id">Pilih Mini Level Kosakata</label>
                                        <select name="vocabulary_mini_course_id" id="vocabulary_mini_course_id" class="form-control" required>
                                            <option value="">Pilih Mini Level Kosakata</option>
                                            @foreach ($courses as $course)
                                                <option value="{{ $course->id }}"
                                                    {{ $course->id == @$data->vocabulary_mini_course_id ? 'selected' : '' }}>
                                                    {{ $course->title }}</option>
                                            @endforeach
                                        </select>
                                        {!! $errors->first('vocabulary_mini_course_id', '<label class="help-block error-validation">:message</label>') !!}
                                    </div>
                                </div>
                            ...
                            <a href="{{ route('vocabulary-mini-course-questions.index') }}"
