    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ $title }} Verb Question</h4>
                        <br>
                        <form class="forms-sample"
                            action="{{ @$data ? route('verb-questions.update', $data->id) : route('verb-questions.store') }}"
                                        ...
                                        <select name="verb_course_id" id="verb_course_id" class="form-control" required>
                                            ...
                                            @foreach ($courses as $course)
                                                <option value="{{ $course->id }}"
                                                    {{ $course->id == @$data->verb_course_id ? 'selected' : '' }}>
                                                    {{ $course->title }}</option>
                                            @endforeach
                                        </select>
                                        {!! $errors->first('verb_course_id', '<label class="help-block error-validation">:message</label>') !!}
                                    </div>
                                </div>
                            ...
                            <a href="{{ route('verb-questions.index') }}"
