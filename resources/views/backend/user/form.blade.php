                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{ hasErrorField($errors, 'first_name') }}"
                                            ...
                                            value="{{ old('first_name', @$data->first_name) }}" placeholder="First Name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{ hasErrorField($errors, 'last_name') }}"
                                            ...
                                            value="{{ old('last_name', @$data->last_name) }}" placeholder="Last Name">
                                        {!! $errors->first('last_name', '<label class="help-block error-validation">:message</label>') !!}
                                    </div>
                                    <div class="form-group">
                                        <label for="username">User Name</label>
                                        <input type="text" class="form-control {{ hasErrorField($errors, 'username') }}"
                                            id="username" name="username" value="{{ old('username', @$data->username) }}"
                                            placeholder="User Name">
                                        {!! $errors->first('username', '<label class="help-block error-validation">:message</label>') !!}
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>Role </label>
                                        <select name="role"
                                            class="form-control select2 {{ hasErrorField($errors, 'role') }}" id="role">
                                            ...
                                            @foreach ($roles as $j => $role)
                                                @php
                                                    ...
                                                    if ($role->slug == old('role')) {
                                                        $selected = 'selected';
                                                    } elseif (@$data->role_slug == $role->slug) {
                                                        $selected = 'selected';
                                                    }
                                    ...
                                    <div class="form-group">
                                        <label>Hub </label>
                                        <select name="hub"
                                            class="form-control select2 {{ hasErrorField($errors, 'hub') }}" id="hub">
                                            <option value="">Choose</option>
                                            @foreach ($hubs as $j => $hub)
                                                @php
                                                    $selected = '';
                                                    if ($hub->id == old('hub')) {
                                                        $selected = 'selected';
                                                    } elseif (@$data->id == $hub->id) {
                                                        $selected = 'selected';
                                                    }

                                                @endphp
                                                <option value="{{ $hub->id }}" {{ $selected }}>
                                                    {{ ucwords($hub->name) }}</option>
                                            @endforeach
                                        </select>
                                        {!! $errors->first('hub', '<label class="help-block error-validation" id="msg_role">:message</label>') !!}
                                    </div>
                                </div>
                            </div>
