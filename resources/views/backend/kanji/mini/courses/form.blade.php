...
@endphp
@section('title', 'Kanji Mini Course ' . $title)
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ $title }} Kanji Mini Course</h4>
                        <br>
                        <form class="forms-sample"
                            action="{{ @$data ? route('kanji-mini-courses.update', $data->id) : route('kanji-mini-courses.store') }}"
                            ...
                            <a href="{{ route('kanji-mini-courses.index') }}"
