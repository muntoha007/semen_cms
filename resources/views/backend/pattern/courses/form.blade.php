                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample"
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="pattern_education_id">Education</label>
                                        <select name="pattern_education_id" id="pattern_education_id" class="form-control"
                                            required>
                                            <option value="">Select Education</option>
                                            @foreach (@$educations as $edu)
                                                <option value="{{ $edu->id }}"
                                                    {{ $edu->id == @$data->pattern_education_id ? 'selected' : '' }}>
                                                    {{ $edu->title }}</option>
                                            @endforeach
                                        </select>
                                        {!! $errors->first('pattern_education_id', '<label class="help-block error-validation">:message</label>') !!}
                            ...
                            <a href="{{ route('pattern-courses.index') }}"
