            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        @isPermitted('ability-course-questions.create')
                        <div class="form-group">
                            <a href="{{ route('ability-course-questions.create') }}" type="button" class="btn btn-outline-info btn-rounded btn-fw btn-sm">
