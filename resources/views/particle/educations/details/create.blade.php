    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col">
                <div class="card">
                    <!-- Card header -->
                    <div class="card-header border-0"><strong>Add New Particle Education</strong> </div>
                    <div class="card-body">
                        <form action="{{ route('particles.educations.details.create', ['files' => true]) }}" method="post"
