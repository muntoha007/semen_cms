    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col">
                <div class="card">
                    <!-- Card header -->
                    <div class="card-header border-0"><strong>Add New Verb Sentence</strong> </div>
                    <div class="card-body">
                        <form action="{{ route('verbs.sentences.create', ['files' => true]) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="verb_change_id">Verbs Changes</label>
                                        <select name="verb_change_id" id="verb_change_id" class="form-control">
                                            <option value="">Select Verbs Changes</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="is_active" id="status" class="form-control">
                                            ...
                                            <option {{ @$sentence->is_active == 0 ? 'selected' : '' }} value="0">
                                                inactive
                                            </option>
                                        </select>
                                    </div>
