...
class DriverController extends Controller
{
    ...
    protected $redirectAfterSave = 'driver.index';
    protected $moduleName = 'Driver';
    /**
    ...
    {
        return $dataTable->render('backend.driver.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.driver.form', compact('data'));
    }
