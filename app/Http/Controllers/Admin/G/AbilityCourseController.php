...
class AbilityCourseController extends Controller
{
    ...
    {
        $courses = MasterAbilityCourse::where('is_active', 1)->get();
        $levels = MasterAbilityCourseLevel::where('is_active', 1)->get();
        return view('backend.ability.courses.form', compact('courses', 'levels'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.ability.courses.form', compact('data', 'courses', 'levels'));
    }
