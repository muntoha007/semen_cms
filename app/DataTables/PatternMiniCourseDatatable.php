...
class PatternMiniCourseDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                $edit_url = route('pattern-mini-courses.edit', $data->id);
     ...
     */
    public function query(PatternMiniCourse $model)
    {
    ...
    {
        return 'PatternMiniCourse_' . date('YmdHis');
    }
}
