...
class AbilityCourseDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                $edit_url = route('ability-courses.edit', $data->id);
     ...
     */
    public function query(AbilityCourse $model)
    {
    ...
    {
        return 'AbilityCourse_' . date('YmdHis');
    }
}
