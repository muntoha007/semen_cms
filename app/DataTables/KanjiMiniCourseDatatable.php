...
class KanjiMiniCourseDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                $edit_url = route('kanji-mini-courses.edit', $data->id);
     ...
     */
    public function query(KanjiMiniCourse $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('kanji-mini-course-table')
    ...
    {
        return 'KanjiMiniCourse_' . date('YmdHis');
    }
}
