...
class MasterGroupDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                $edit_url = route('master-groups.edit', $data->id);
     ...
     */
    public function query(MasterGroup $model)
    {
        ...
        return $model->newQuery()
            ...
            ->select([
                ...
                'master_groups.code',
                'master_groups.name',
                'master_groups.is_active',
                'master_groups.created_at',
                'master_groups.updated_at',
    ...
    {
        return 'MasterGroup_' . date('YmdHis');
    }
}
