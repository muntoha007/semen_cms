...
class VerbMiniCourseDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                $edit_url = route('verb-mini-courses.edit', $data->id);
    ...
    {
        return 'VerbMiniCourse_' . date('YmdHis');
    }
}
