...
class MasterAbilityCourseDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                $edit_url = route('master-ability-courses.edit', $data->id);
     ...
     */
    public function query(MasterAbilityCourse $model)
    {
    ...
    {
        return 'MasterAbilityCourse_' . date('YmdHis');
    }
}
