...
class KanjiCourseDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                $edit_url = route('kanji-courses.edit', $data->id);
     ...
     */
    public function query(KanjiCourse $model)
    {
        ...
        return $model->newQuery()
            ...
            ->select([
                ...
                'kanji_courses.code',
                'kanji_courses.title',
                'kanji_courses.is_active',
                'kanji_courses.created_at',
                'kanji_courses.updated_at',
    ...
    {
        return 'KanjiCourse_' . date('YmdHis');
    }
}
