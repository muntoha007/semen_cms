...
class ParticleCourseDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                $edit_url = route('particle-courses.edit', $data->id);
     ...
     */
    public function query(ParticleCourse $model)
    {
    ...
    {
        return 'ParticleCourse_' . date('YmdHis');
    }
}
