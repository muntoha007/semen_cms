...
class KanjiSampleDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($data) {
                $edit_url = route('kanji-samples.edit', $data->id);
     ...
     */
    public function query(KanjiSample $model)
    {
        ...
        return $model->newQuery()
            ...
            ->select([
                'kanji_samples.id',
                'kanji_samples.code',
                'kanji_samples.sample_kanji',
                'kanji_samples.sample_hiragana',
                'kanji_samples.sample_idn',
                'kanji_samples.is_active',
                'kanji_samples.created_at',
                'kanji_samples.updated_at',
    ...
    {
        return 'KanjiSample_' . date('YmdHis');
    }
}
