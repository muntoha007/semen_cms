...
Route::group(['middleware' => ['sentinelAuth','checkAccess'],'namespace' => 'Admin','prefix' => 'admin'], function () {
    ...
    Route::resource('assignment', 'AssignmentController')->except('show');
    Route::resource('assignment/{id}/documents', 'DocumentAssignmentController')->except('show');
    Route::post('assignment/unpacking', 'AssignmentController@unpacking')->name('unpacking');
    Route::post('assignment/{id}/new-do', 'AssignmentController@newDo')->name('new-do');
});
